...
print(gcf,'-dpdf',sprintf('~/pmod/plots/pmod_wc_highres_fc_gain%d_G%d_v%d.pdf',igain,G,v_sim))
...
load(sprintf('~/pmod/proc/pmod_wc_highres_indivfits_taskandrest_v%d.mat',v_sim))
