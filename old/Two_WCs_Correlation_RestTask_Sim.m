...
save WCs_Correlations_ParamSpace2.mat
...
pos=get(gca,'position');
imagescnan(Iis,Ies,CeE(:,:,2)-CeE(:,:,1),[-.05 .05])
...
print(gcf,'-dpdf',sprintf('~/pmod/plots/pmod_model_phasepolots_twonodes.pdf'))